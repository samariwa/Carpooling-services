 ...
 * @author samue
 */
public class WestlandsRoute
{
    // adding a GUI frame with a title 'Westlands Route' on it
        JFrame westlands=new JFrame("Westlands Route");
        JPanel a=new JPanel();
        ...
        public void formGUI()
        {
            ...
            westlands.setSize(2000,1300);
            //setting how the gui will be closed by the user
            westlands.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            westlands.setVisible(true); 
        }
